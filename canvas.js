...
Lig4Canvas.prototype.writeTurn = function (player) {
  if (player == 2 || lig4.rounds == 0) {
    ...
    this.ctx.fillStyle = 'red';
    this.ctx.fillText("Player 1's turn", 170, 520);
  }
  else {
    this.ctx.font = '36px sans-serif';
    this.ctx.fillStyle = 'blue';
    this.ctx.fillText("Player 2's turn", 170, 520);
  }
}

Lig4Canvas.prototype.tie = function () {
  this.ctx.font = '36px sans-serif';
  this.ctx.fillText("It's a tie", 170, 520);
}

Lig4Canvas.prototype.winner = function (player) {
  this.ctx.font = '36px sans-serif';
  this.ctx.fillText('Player ' + player + ' wins!!!', 170, 520);
}
